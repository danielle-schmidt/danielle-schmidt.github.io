...
export function Home() {
      ...
      <div className="home-page-content">
        ...
        <div className="text-content">
          <p>
            ...
            livability. As a community-engaged mixed-methodologist, Schmidt-Larios integrates ethnographic sensibilities and spatial thinking to investigate 
            the concepts of place, land, and home. Her research has been published in journals such as <em>Rural Sociology</em> and{" "}
  <em>Agriculture and Human Values</em>, and has received financial support from organizations including the Rural Sociological Society (RSS) 
        ...
        Schmidt-Larios’s dissertation, <em>Spatiotemporalities of Agricultural Land Loss</em>, explores the social implications of change in land tenure and use. 
            ...
            Findings aim to speak to the ways in which change in land tenure and use reflect evolving environmental and land management priorities, 
          ...
          <p>
            ...
            rider. She currently resides in Madison, Wisconsin with her two- and
            four-legged family members: Leo, Chet, Archie, and Maslow.
          </p>
          <div className="cv-link-container">
            <a
              className="cv-link"
              href="/Sep2026_CV_Schmidt-Larios.pdf"
              target="_blank"
            >
              View CV
            </a>
